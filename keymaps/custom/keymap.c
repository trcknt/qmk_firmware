...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [0] = LAYOUT(
    ...
    LT(4, KC_ESC), MT(MOD_LGUI, KC_TAB), MT(MOD_LSFT, KC_SPC), LT(1, KC_LNG1), LT(5, KC_LNG2), LT(2,KC_ENT), LT(3,KC_BSPC)   , KC_DEL
  ),
  ...
  [4] = LAYOUT(
    ...
    _______  ,                       _______  , QK_KB_9  , QK_KB_6   , QK_KB_7   , QK_KB_10  , _______  ,                      _______
  ),
